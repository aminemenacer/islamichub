        ...
        <div class="card-body">
          ...
          <div class="tab-content text-center">
            ...
            <div class="tab-pane" id="profile" role="tabpanel" v-if="information != null">
              ...
              <hr class="container" />
              <div class="btn">
                <h3 class="container text-left" style="line-height: 1.6em">
                  {{ tafseer }}
                </h3>
              </div>
            </div>
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
          <div class="row container-fluid" style="flex-direction: column">
            <div class="custom-scrollbar" style="
              ...
              <ul class="col-md-4 list-group container-fluid root" style="max-width: 100%; cursor: pointer" :class="{
                                        selected: selectedIndex === ayahId,
                                    }" v-for="(ayah, index) in ayahs" :key="index" @click="getTafseers(ayah)">
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
          <div class="col-12 row" style="">
            <div class="ml-2 col-md-12 card bg-light row" style="
                                    display: flex;
                                    border: 5px solid #c3e6cb;
                                    padding: 8px;
                                ">
