    ...
    <div id="app">
        ...
        <div class="row text-center pt-3 container-fluid">
            ...
            >
                <div class="row">
                    ...
                    >
                        <label class="pt-2 pl-3 pr-2" style="display: flex"
                            >Imam:</label
                        >
                        <form class="col-md-3">
                            <select
        ...
        <div class="row">
            <div
                ...
                v-for="data in ahadiths"
                :key="data.id"
                :value="data.id"
            >
                <div
                    class="card-body"
                    style="background: white; border: 3px solid #c3e6cb"
                >
                    ...
                    <div class="" style="background: lighgrey">
                        ...
                        <b style="background: lighgrey">In-Book Reference:</b
                        ><span style="background: lighgrey">
                            Book {{ data.chapter_id }}</span
                        ><br />
                        <b style="background: lighgrey">Hadith Num:</b>
                        <span style="background: lighgrey">{{ data.chapter.imam_id }}</span
                        ><br />
                    </div>
                </div>
            </div>
