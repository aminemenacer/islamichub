<template>
  <div class="modal fade" id="tafseerNote" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true" ref="modal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel2">Write a Note</h5>
