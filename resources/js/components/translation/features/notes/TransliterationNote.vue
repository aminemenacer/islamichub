    ...
    <form @submit.prevent="createNote">
     <div class="row container mt-3">
      ...
      <div class="col">
       ...
       <textarea v-model="form.ayah_notes" class="form-control pb-2" rows="5" placeholder="Save your notes and personal reflections privately. Oftentimes your reflections can deeply resonate with your connection to the Quran, and your relationship with Allah."></textarea>
      </div>
     </div>
