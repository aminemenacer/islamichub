...
<div id="app">
  ...
  <h2 class="pt-3 text-center"><strong>Ahadith Shaikh Shah Waliullah</strong></h2>
  ...
  <div class="row py-3">
    <div class="col-lg-12 mx-auto">
      <button type="button" class="btn text-white mb-3 mr-2" style="background:brown; float:right" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Correction
      </button>
...
<script>
import hadith from '/Users/amine/Desktop/islamichub/storage/three_main/shah_book.json';
