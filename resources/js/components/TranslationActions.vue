<template>
  <div class="row">
    <div style="padding: 5px; display: flex; flex-wrap: wrap;">
      ...
      <div class="col-2">
        <TwitterShareTranslation :targetElementRef="targetTranslationRef" :translationText="translation" />
      </div>
      <div class="col-2">
        <i
          @click="$emit('submit-form')"
          class="bi bi-bookmark mr-2 h4"
          aria-expanded="false"
          data-bs-placement="top"
...
export default {
  ...
  methods: {
    openFolderSelectionModal() {
      this.$emit('open-modal', 'folderSelection');
    },
    captureTranslation() {
    ...
    handleFolderSelected(folderId) {
      ...
      // Handle the folder selection logic here
    },
  },
};
</script>
