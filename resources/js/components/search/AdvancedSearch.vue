<template>
    <div>
        ...
        <div>
            <div
                class="container input-group pb-3"
            ...
            >
                <input
                    ...
                    class="form-control mr-3 pb-2 mobile-only"
                    style="
                        flex: 1;
                ...
                >
                    <i
                        class="bi text-white pr-1"
                        :class="isListening ? 'bi-stop-fill' : 'bi-mic-fill'"
                        aria-hidden="true"
                    ></i
                    ><span style="color: white"><b>Speak</b></span>
                </button>
                <!--
        ...
        <h3 v-if="isListening" class="pt-1">
            <b class="pt-1">Listening...</b>
        </h3>
                        ...
                        <div :id="'result-' + result.id">
                            ...
                            <div>
                                ...
                                <template
                                    ...
                                    v-if="
                                        showMoreLink &&
                                        result.originalTafseer.length > 200
                                    "
                                >
                                    <a
                                        class="href pb-2"
                            ...
                            <div>
                                ...
                                <template
                                    ...
                                    v-if="
                                        showMoreLink &&
                                        result.transliteration.length > 200
                                    "
                                >
                                    <a
                                        class="href pb-2"
    ...
    methods: {
        ...
        startVoiceRecognition() {
            ...
            if (!SpeechRecognition) {
                alert(
                    "Speech Recognition is not supported in this browser. Please use Google Chrome or a compatible browser."
                );
        ...
        highlightSearch(text) {
            ...
            return text.replace(
                regex,
                '<strong style="background-color: #3EB489;">$1</strong>'
            );
        },
        ...
        searchWord() {
            ...
            axios
                .post("/search-translations", payload)
                .then((response) => {
